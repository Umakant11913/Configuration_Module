...
class SendfirmwareExecutionEmailAlert extends Notification
{
    use Queueable;
    ...
    protected $router;
    protected $frequency;
    public function __construct($user, $router, $frequency)
    {
        $this->user = $user;
        $this->router = $router;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject('Send Firmware Execution Email')
...
//        ->line(new HtmlString('You can disable the Email alerts anytime by going on https://pdo.pmwani.net/notification-settings . For more details, please login to your account.'));
    ...
    {
        return [
            'subject' => 'Send Firmware Execution Email', // Added subject
